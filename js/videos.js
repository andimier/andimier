	...
	var videosUrl = 'http://vimeo.com/api/v2/album/2891523' + vimeoUserName + '/videos.json?callback=' + videosCallback;
	...
	function showThumbs(videos) {
		...
		var divs = document.getElementsByClassName('video');
		...
		var margen = $('.video').first().css('margin-left');
		...
		function InicioVideos1(){
			...
			thumbs.style.height = ( divs[0].offsetWidth * filas ) + 100 + 'px';
